...
export type MerchantBranding = {
   ...
   */
  subscriptionState: 'setup' | 'trial' | 'active' | 'grace_period' | 'suspended' | 'billing_closed';
...
function parseBrandingResponse(data: Record<string, unknown>): MerchantBranding {
  ...
  return {
    ...
    subscriptionState: (() => {
      ...
      return raw === 'setup' || raw === 'trial' || raw === 'active' || raw === 'grace_period' || raw === 'suspended' || raw === 'billing_closed'
        ? raw
        : 'active';
    })(),
